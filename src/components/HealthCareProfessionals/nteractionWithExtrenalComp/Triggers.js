...
const Triggers = () => {
  return (
    <div className="ml-16 h-[14rem] w-[43%] bg-[#1C1F24] shadow-s mt-[1.5rem] mb-4 border-[0.5px] border-solid border-zinc-600/20 blur-0 rounded-3xl">
    ...
    <div className='flex items-center w-[90%] ml-[1.5rem] mt-4'>
              <span><img src={dot} alt="a dot" className='mb-[1.4rem]'></img></span>  
